...
2.Database Management System (DBMS): SQLlite a lightweight, serverless, self-contained database often used for smaller projects or embedded applications. It's built directly into Python. 
...
2.Database: If the project uses a database (e.g., SQLite, MySQL), ensure it is installed and configured. 

3.For SQLite, it's typically included with Python; for others, separate installation may be needed. 
